...
CREATE TABLE maintenances (
	...
	tags_evaltype            integer         WITH DEFAULT '0'          NOT NULL,
...
CREATE TABLE hosts (
	...
	proxy_address            varchar(255)    WITH DEFAULT ''           NOT NULL,
	auto_compress            integer         WITH DEFAULT '1'          NOT NULL,
	PRIMARY KEY (hostid)
);
...
CREATE TABLE items (
	...
	timeout                  varchar(255)    WITH DEFAULT '3s'         NOT NULL,
	url                      varchar(2048)   WITH DEFAULT ''           NOT NULL,
	query_fields             varchar(2048)   WITH DEFAULT ''           NOT NULL,
	posts                    varchar(2048)   WITH DEFAULT ''           NOT NULL,
	status_codes             varchar(255)    WITH DEFAULT '200'        NOT NULL,
	follow_redirects         integer         WITH DEFAULT '1'          NOT NULL,
	post_type                integer         WITH DEFAULT '0'          NOT NULL,
	http_proxy               varchar(255)    WITH DEFAULT ''           NOT NULL,
	headers                  varchar(2048)   WITH DEFAULT ''           NOT NULL,
	retrieve_mode            integer         WITH DEFAULT '0'          NOT NULL,
	request_method           integer         WITH DEFAULT '0'          NOT NULL,
	output_format            integer         WITH DEFAULT '0'          NOT NULL,
	ssl_cert_file            varchar(255)    WITH DEFAULT ''           NOT NULL,
	ssl_key_file             varchar(255)    WITH DEFAULT ''           NOT NULL,
	ssl_key_password         varchar(64)     WITH DEFAULT ''           NOT NULL,
	verify_peer              integer         WITH DEFAULT '0'          NOT NULL,
	verify_host              integer         WITH DEFAULT '0'          NOT NULL,
	allow_traps              integer         WITH DEFAULT '0'          NOT NULL,
	PRIMARY KEY (itemid)
);
...
CREATE TABLE actions (
	...
	formula                  varchar(255)    WITH DEFAULT ''           NOT NULL,
	pause_suppressed         integer         WITH DEFAULT '1'          NOT NULL,
...
CREATE TABLE config (
	...
	ok_period                varchar(32)     WITH DEFAULT '5m'         NOT NULL,
	blink_period             varchar(32)     WITH DEFAULT '2m'         NOT NULL,
	problem_unack_color      varchar(6)      WITH DEFAULT 'CC0000'     NOT NULL,
	problem_ack_color        varchar(6)      WITH DEFAULT 'CC0000'     NOT NULL,
	ok_unack_color           varchar(6)      WITH DEFAULT '009900'     NOT NULL,
	ok_ack_color             varchar(6)      WITH DEFAULT '009900'     NOT NULL,
	...
	custom_color             integer         WITH DEFAULT '0'          NOT NULL,
	http_auth_enabled        integer         WITH DEFAULT '0'          NOT NULL,
	http_login_form          integer         WITH DEFAULT '0'          NOT NULL,
	http_strip_domains       varchar(2048)   WITH DEFAULT ''           NOT NULL,
	http_case_sensitive      integer         WITH DEFAULT '1'          NOT NULL,
	ldap_configured          integer         WITH DEFAULT '0'          NOT NULL,
	ldap_case_sensitive      integer         WITH DEFAULT '1'          NOT NULL,
...
CREATE TABLE functions (
	...
	itemid                   bigint                                    NOT NULL,
	triggerid                bigint                                    NOT NULL,
	name                     varchar(12)     WITH DEFAULT ''           NOT NULL,
...
CREATE TABLE graph_theme (
	...
	colorpalette             varchar(255)    WITH DEFAULT ''           NOT NULL,
...
CREATE TABLE media (
	...
	userid                   bigint                                    NOT NULL,
	mediatypeid              bigint                                    NOT NULL,
	sendto                   varchar(1024)   WITH DEFAULT ''           NOT NULL,
...
CREATE TABLE sysmaps (
	...
	userid                   bigint                                    NOT NULL,
	private                  integer         WITH DEFAULT '1'          NOT NULL,
	show_suppressed          integer         WITH DEFAULT '0'          NOT NULL,
...
CREATE TABLE events (
	...
	ns                       integer         WITH DEFAULT '0'          NOT NULL,
	name                     varchar(2048)   WITH DEFAULT ''           NOT NULL,
	severity                 integer         WITH DEFAULT '0'          NOT NULL,
	PRIMARY KEY (eventid)
);
...
CREATE TABLE acknowledges (
	...
	old_severity             integer         WITH DEFAULT '0'          NOT NULL,
	new_severity             integer         WITH DEFAULT '0'          NOT NULL,
...
CREATE TABLE autoreg_host (
	...
	listen_dns               varchar(255)    WITH DEFAULT ''           NOT NULL,
...
CREATE TABLE event_suppress (
	...
	eventid                  bigint                                    NOT NULL,
	maintenanceid            bigint                                    NULL,
	suppress_until           integer         WITH DEFAULT '0'          NOT NULL,
...
CREATE TABLE maintenance_tag (
	...
	maintenanceid            bigint                                    NOT NULL,
	tag                      varchar(255)    WITH DEFAULT ''           NOT NULL,
	operator                 integer         WITH DEFAULT '2'          NOT NULL,
	value                    varchar(255)    WITH DEFAULT ''           NOT NULL,
